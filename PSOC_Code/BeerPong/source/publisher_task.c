...
static void publisher_init(void)
{
    ...
    cyhal_gpio_init(P11_4, CYHAL_GPIO_DIR_INPUT, CYHAL_GPIO_DRIVE_NONE, true);
    cyhal_gpio_register_callback(P11_4, isr_button_press, NULL);
    cyhal_gpio_enable_event(P11_4, CYHAL_GPIO_IRQ_BOTH, 3, true);
    cyhal_gpio_init(P10_3, CYHAL_GPIO_DIR_INPUT, CYHAL_GPIO_DRIVE_NONE, true);
    cyhal_gpio_register_callback(P10_3, isr_button_press, NULL);
    cyhal_gpio_enable_event(P10_3, CYHAL_GPIO_IRQ_BOTH, 3, true);
    cyhal_gpio_init(P10_4, CYHAL_GPIO_DIR_INPUT, CYHAL_GPIO_DRIVE_NONE, true);
    cyhal_gpio_register_callback(P10_4, isr_button_press, NULL);
    cyhal_gpio_enable_event(P10_4, CYHAL_GPIO_IRQ_BOTH, 3, true);
    cyhal_gpio_init(P12_3, CYHAL_GPIO_DIR_INPUT, CYHAL_GPIO_DRIVE_NONE, true);
    cyhal_gpio_register_callback(P12_3, isr_button_press, NULL);
    cyhal_gpio_enable_event(P12_3, CYHAL_GPIO_IRQ_BOTH, 3, true);
    cyhal_gpio_init(P10_1, CYHAL_GPIO_DIR_INPUT, CYHAL_GPIO_DRIVE_NONE, true);
    cyhal_gpio_register_callback(P10_1, isr_button_press, NULL);
    cyhal_gpio_enable_event(P10_1, CYHAL_GPIO_IRQ_BOTH, 3, true);
    cyhal_gpio_init(P10_5, CYHAL_GPIO_DIR_INPUT, CYHAL_GPIO_DRIVE_NONE, true);
    cyhal_gpio_register_callback(P10_5, isr_button_press, NULL);
    cyhal_gpio_enable_event(P10_5, CYHAL_GPIO_IRQ_BOTH, 3, true);
...
static void publisher_deinit(void)
{
    ...
    cyhal_gpio_register_callback(P11_4, NULL, NULL);
    cyhal_gpio_enable_event(P11_4, CYHAL_GPIO_IRQ_BOTH, 3, false);
    cyhal_gpio_free(P11_4);
    cyhal_gpio_register_callback(P10_3, NULL, NULL);
    cyhal_gpio_enable_event(P10_3, CYHAL_GPIO_IRQ_BOTH, 3, false);
    cyhal_gpio_free(P10_3);
    cyhal_gpio_register_callback(P10_4, NULL, NULL);
    cyhal_gpio_enable_event(P10_4, CYHAL_GPIO_IRQ_BOTH, 3, false);
    cyhal_gpio_free(P10_4);
    cyhal_gpio_register_callback(P12_3, NULL, NULL);
    cyhal_gpio_enable_event(P12_3, CYHAL_GPIO_IRQ_BOTH, 3, false);
    cyhal_gpio_free(P12_3);
    cyhal_gpio_register_callback(P10_1, NULL, NULL);
    cyhal_gpio_enable_event(P10_1, CYHAL_GPIO_IRQ_BOTH, 3, false);
    cyhal_gpio_free(P10_1);
    cyhal_gpio_register_callback(P10_5, NULL, NULL);
    cyhal_gpio_enable_event(P10_5, CYHAL_GPIO_IRQ_BOTH, 3, false);
    cyhal_gpio_free(P10_5);
}
...
static void isr_button_press(void *callback_arg, cyhal_gpio_event_t event)
{
    ...
    /* Read Sensor value */
    IR1_val = cyhal_gpio_read(P11_4) ? "0" : "1";
    IR2_val = cyhal_gpio_read(P12_3) ? "0" : "1";
    IR3_val = cyhal_gpio_read(P10_5) ? "0" : "1";
    IR4_val = cyhal_gpio_read(P10_1) ? "0" : "1";
    IR5_val = cyhal_gpio_read(P10_4) ? "0" : "1";
    IR6_val = cyhal_gpio_read(P10_3) ? "0" : "1";

    /* Make string to send */
    strcpy(allSensorVal, IR1_val);
    strcat(allSensorVal, IR2_val);
    strcat(allSensorVal, IR3_val);
    strcat(allSensorVal, IR4_val);
    strcat(allSensorVal, IR5_val);
    strcat(allSensorVal, IR6_val);


    /* Assign the publish message payload so that the device state toggles. */
    publisher_q_data.data = allSensorVal;
